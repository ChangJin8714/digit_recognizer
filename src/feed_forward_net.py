...
class Network(object):
    ...
    def StochasticGradientDescent(self, training_data, epochs, mini_batch_size, eta, validation_data=None):
        ''' 
        ...
        for epoch in xrange(epochs):
            ...
            if validation_data:
                print "Epoch {0}: {1} / {2}".format(epoch, self.evaluate(validation_data), n_validation)
            else:
    ...
    def predict(self, test_data):
        return [np.argmax(self.feedforward(test_x)) for test_x in test_data]
